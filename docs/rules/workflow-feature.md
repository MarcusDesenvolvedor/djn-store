...
* Authentication
* Catalog (per-game storefront)
* Product management
* Order management
* Checkout
* Admin (stock, pricing, orders, sales dashboard)
...
* Respect **game/catalog context** and **admin panel** authorization rules (no SaaS multi-tenancy — see `architecture.md`)
