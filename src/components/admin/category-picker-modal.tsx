      ...
      >
        <div className="border-b border-outline-variant px-5 py-4">
          ...
          <input
            ...
            className="mt-4 w-full rounded border border-outline-variant bg-background px-3 py-2 font-body text-body text-on-surface outline-none ring-primary focus:border-transparent focus:ring-1 disabled:cursor-not-allowed disabled:opacity-50"
          />
        </div>

        <div className="min-h-0 flex-1 overflow-y-auto px-3 py-3">
          {loading ? (
            <div className="flex flex-col items-center justify-center gap-3 px-2 py-10" role="status" aria-live="polite">
              <AdminInlineSpinner className="h-8 w-8 border-[3px]" aria-hidden />
              <p className="text-center font-body-sm text-body-sm text-on-surface-variant">Carregando categorias…</p>
            </div>
          ) : null}
          {loadError ? (
